Luis Alberto Hoil Ambros.py
"""
Luis Alberto Hoil Ambros
Programa que determina si el hit point esta fueramo dentro del triangulo
se le solicita al usuario que ingrese las cordenadas para el hit point
"""
...
while True:
    axis=input("Teclea el eje que deseas visualizar 'x,y,z' o pulsa Esc para salir ?:")
